import re
with open('public/index.html', 'r', encoding='utf-8') as f: data = f.read()
data = re.sub(r'\\{\|s*cartaMesa\\.valor\|*\\}\\}', '{{ formatValor(cartaMesa.valor) }}', data)
...
if 'formatValor(val)' not in data:
    data = data.replace('methods: {', method_str)
with open('public/index.html', 'w', encoding='utf-8') as f: f.write(data)